...
using BlogApp.Data.Concrete.EntityFrameworkCore;
...
namespace BlogApp.WebUI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env,BlogContext context)
        {
            ...
            {
                app.UseDeveloperExceptionPage(); //Hata sayfalarını bize göstersin.
            }
            app.UseStatusCodePages(); //Durum sayfaları karşımıza gelsin diye.
            app.UseStaticFiles(); //wwwrootun içindeki static dosyaları erişilebilir hale getirmek için.
